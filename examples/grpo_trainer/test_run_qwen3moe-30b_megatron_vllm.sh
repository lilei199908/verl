...
python3 -m verl.trainer.main_ppo --config-path=config \
    ...
    actor_rollout_ref.ref.profiler.tool=torch \
    actor_rollout_ref.ref.profiler.enable=True \
    actor_rollout_ref.ref.profiler.ranks='[0,1]' \
    actor_rollout_ref.ref.profiler.save_path=/data1/lilei/once \
    actor_rollout_ref.ref.profiler.tool_config.torch.step_start=0 \
    actor_rollout_ref.ref.profiler.tool_config.torch.step_end=2
